function pdf_path = dti_stats_pipeline(job_dir_path, dwmri_path, bvec_path, bval_path, mask_path, fsl_path, camino_path, csf_info, bet_params, movement_params_path)
